  ...
  return (
    <div className='c has_border'>
      <LazyLoad
        ...
        rootMargin='-20%'
      >
        <div className='section_border_top' />
        <div className='section_border_left' />
        <div className='section_border_right' />
        <div className='section_border_bottom' />
        <div className='section_border_middle' />
            ...
            return (
              ...
              >
                <LazyLoad className={`${style.item_inner_wrap}`}>
                  {!islastRow && index % 2 === 0 && (
                    <div className='section_item_border_bottom' />
                  )}
