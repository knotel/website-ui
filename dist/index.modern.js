...
import React__default, { useState, useEffect, Suspense, lazy, useRef, createContext, useContext } from 'react';
import $ from 'jquery-slim';
import { get, isObject, isEmpty, chunk } from 'lodash';
...
var Dropdown = function Dropdown(props) {
  ...
  var _useState = useState(getPrompt()),
    sprompt = _useState[0];
  var _useState2 = useState(get(options, input.value) || ""),
    valueEntered = _useState2[0],
    setValueEntered = _useState2[1];
  ...
  var setDefaultValue = function setDefaultValue() {
    var onChange = input.onChange,
      value = input.value;
    var labels = get(Object.values(options), "[0]", "");
    var selectedValue = get(options, value) || "";
...
var NormalLink$2 = lazy(function () {
...
var NormalLink$3 = lazy(function () {
  return Promise.resolve().then(function () { return NormalLink$1; });
});
...
var TextImage = function TextImage(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    return /*#__PURE__*/React__default.createElement("div", {
      className: style$c.section + " " + (get(item, 'image_position') === 'right' ? "col_50_50 " + style$c.right_side : "col_50_50"),
      key: "text_img_" + i
...
var TextImageBlock = function TextImageBlock(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    return /*#__PURE__*/React__default.createElement("div", {
      className: "section_item " + style$g.text_image + " " + (get(item, 'image_position') === 'left' ? "col_66_33 " + style$g.left_side : "col_33_66"),
      key: "text_img_" + i
    }, i + 1 !== items.length && /*#__PURE__*/React__default.createElement("div", {
      className: "section_item_border_bottom"
    }), /*#__PURE__*/React__default.createElement("div", {
...
var TermsMenu = function TermsMenu(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    return /*#__PURE__*/React__default.createElement(NormalLink, {
      link: item.link,
      className: style$j.menu_label + " " + (get(selected, 'link') === get(item, 'link') ? " " + style$j.active : ''),
      key: "terms_menu_" + i
    }, item.label);
  })));
};
...
var TextImageSlider = function TextImageSlider(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(EqualHeight, null, /*#__PURE__*/React__default.createElement("div", {
    ...
    return /*#__PURE__*/React__default.createElement("div", {
      className: "section_item " + style$o.text_image + " " + (get(item, 'image_position') === 'left' ? "col_66_33 " + style$o.left_side : "col_33_66"),
      key: "text_img_" + i
    }, i + 1 !== items.length && /*#__PURE__*/React__default.createElement("div", {
      className: "section_item_border_bottom"
    }), /*#__PURE__*/React__default.createElement("div", {
